...
### *Data sources:* 
- The Worldwide governance indicators (WGI) project provides aggregated and individual governance indicators for over 200 countries over the period 1996-2018 for the above mentioned aspects: [https://info.worldbank.org/governance/wgi/](https://info.worldbank.org/governance/wgi/)
...
- [FAO Database](http://www.fao.org/aquastat/en/databases/) 
- [AQUASTAT](http://www.fao.org/nr/water/aquastat/data/query/index.html)
