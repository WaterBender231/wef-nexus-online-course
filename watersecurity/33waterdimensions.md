...
1. long-term average annual precipitation (mm);
2. total internal renewable water resources per capita (m³/inhab./year);
3. total external renewable water resources (m³/year);		
4. dependency ratio;
5. SDG 6.4.2. water stress (%)
...
[FAO Database](http://www.fao.org/aquastat/en/databases/) and [AQUASTAT](http://www.fao.org/nr/water/aquastat/data/query/index.html)
