...
Unit: currency. For comparing among countries, widely used currencies like USD or EUR are used.
...
Formula:
(ℎ𝑜𝑢𝑠𝑒ℎ𝑜𝑙𝑑 𝑖𝑛𝑐𝑜𝑚𝑒 𝑠𝑝𝑒𝑛𝑡 𝑜𝑛 𝑓𝑢𝑒𝑙 𝑎𝑛𝑑 𝑒𝑙𝑒𝑐𝑡𝑟𝑖𝑐𝑖𝑡𝑦)/(ℎ𝑜𝑢𝑠𝑒ℎ𝑜𝑙𝑑 𝑖𝑛𝑐𝑜𝑚𝑒 )
Unit: currency, USD or EUR are used. The indicator is often expressed as percentage.
Literature Sources: IAEA et al. 2005. Bacon et al. (2010) provide an overview of case studies for expenditure of low-income households on energy in Africa and Asia.
Data Sources: Data on household expenditure on energy is mainly provided by national agencies (e.g., ofgem (2018)).
...
Formula:
(𝑡𝑜𝑡𝑎𝑙 𝑐𝑜𝑠𝑡 𝑜𝑓 𝑒𝑙𝑒𝑐𝑡𝑟𝑖𝑐𝑡𝑦 𝑝𝑟𝑜𝑑𝑢𝑐𝑡𝑖𝑜𝑛)/(𝑡𝑜𝑡𝑎𝑙 𝑒𝑙𝑒𝑐𝑡𝑟𝑖𝑐𝑖𝑦 𝑜𝑢𝑡𝑝𝑢𝑡)
Unit: [€/kWh], [$/kWh]
––––––––––––––––
References
...
Unit: Renewable energy production and total energy production are amounts of energy expressed, e.g., as TWh or PJ. The share can be expressed as a percentage.
...
Formula:
(Total CO_2  emission )/( Total primary energy supply)
Unit: Greenhouse gas emission can be expressed as tons of 〖𝐶𝑂〗_2equivalent. Total primary energy supply can be expressed in Terra Watt Hours or tons of oil equivalent Possible units for carbon intensity, therefore are [t〖𝐶𝑂〗_2 𝑒𝑞/𝑇𝑊ℎ]  or [𝑡〖𝐶𝑂〗_2 𝑒𝑞/𝑡𝑜𝑒].
...
Formula:
(number of deaths)/(energy output)
Unit: The unit is deaths per energy output, commonly expressed in Terra Watt Hours: [1/𝑇𝑊ℎ]
––––––––––––––––
References
